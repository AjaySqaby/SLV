...
export default function RideDetailModal({
  ...
  return (
    <Modal open={isOpen} onClose={onClose} title={`#${rideData.id}`}>
      <div className="text-sm text-[var(--muted-text)] mb-2">
        {rideData.date} • Route:{" "}
        {rideData.route &&
          rideData.route.pickup &&
          rideData.route.pickup.address}{" "}
        →{" "}
        {rideData.route &&
          rideData.route.dropoff &&
          rideData.route.dropoff.address}
      </div>
            ...
            <div className="bg-[var(--surface-bg)] p-6 rounded-lg">
              ...
              <div className="flex items-center mb-4">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-lg text-[var(--primary-black)]">
                ...
                <div className="flex flex-col gap-2 ml-4">
                  <Button
                    className="flex items-center gap-1 bg-[var(--gray-100)] text-[var(--primary-black)] px-3 py-1 rounded font-medium text-sm border border-[var(--gray-200)]"
                    variant="secondary"
                  >
                    <svg
                  ...
                  <Button
                    className="flex items-center gap-1 bg-[var(--blue)] text-white px-3 py-1 rounded font-medium text-sm"
                    variant="primary"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div key={index} className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[var(--muted-text)]">
                        (Grade {student.grade}) • {student.id}
                      </p>
                    </div>
                  </div>
                ))}
        ...
        {activeTab === 3 && (
          <div className="space-y-6">
            {rideData.students.map((student, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-4 border-b border-[var(--surface-muted)]"
              >
                ...
                <div>
                  <StatusBadge
                    ...
                    type={student.status === "Picked up" ? "active" : "default"}
                  />
                </div>
              </div>
            ))}
      ...
      <div className="p-4 border-t border-[var(--border)] flex justify-center space-x-4 mt-6">
        <Button
          variant="secondary"
          className="flex items-center gap-2 px-4 py-2 border border-[var(--border)] rounded-md hover:bg-[var(--surface-muted)]"
        >
          <Map size={18} />
          <span>Route Map</span>
        </Button>
