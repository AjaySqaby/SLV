...
const UpcomingRidesTab = dynamic(() => import("./UpcomingRidesTab"), { ssr: false });
const CompletedRidesTab = dynamic(() => import("./CompletedRidesTab"), { ssr: false });
const AssignedRoutesTab = dynamic(() => import("./AssignedRoutesTab"), { ssr: false });
const VehicleInfoStep = dynamic(() => import("./VehicleInfoStep"), { ssr: false });
const MaintenanceTab = dynamic(() => import("./MaintenanceTab"), { ssr: false });
const OnboardingTab = dynamic(() => import("./OnboardingTab"), { ssr: false });
const BlockedStudentsTab = dynamic(() => import("./BlockedStudentsTab"), { ssr: false });
