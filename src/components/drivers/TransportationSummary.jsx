      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center">
          <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                         <RiRouteLine className="w-6 h-6 text-blue-600" />
          </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center">
          <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                         <RiTimeLine className="w-6 h-6 text-green-600" />
          </div>
          <h3 className="text-sm font-medium text-gray-500 mb-2">Upcoming Rides</h3>
          <p className="text-3xl font-bold text-blue-600">{driverData.upcomingRides}</p>
        </div>

        {/* Assigned Routes */}
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center">
          <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                         <RiRouteLine className="w-6 h-6 text-purple-600" />
          </div>
          <h3 className="text-sm font-medium text-gray-500 mb-2">Assigned Routes</h3>
          <p className="text-3xl font-bold text-purple-600">{driverData.assignedRoutes}</p>
        </div>
      </div>
