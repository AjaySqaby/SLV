            ...
            <tbody>
              {filteredDrivers.map((driver) => (
                <tr key={driver.id} className="border-b border-[var(--gray-100)] hover:bg-[var(--gray-50)] transition-all duration-200 cursor-pointer" onClick={() => handleViewDriver(driver.id)}>
                  ...
                  <td className="px-6 py-4 font-medium hover:bg-[var(--gray-100)] transition-all duration-200">{driver.name}</td>
                  <td className="px-6 py-4 hover:bg-[var(--gray-100)] transition-all duration-200">
                    <div>
                  ...
                  <td className="px-6 py-4 hover:bg-[var(--gray-100)] transition-all duration-200">{driver.vehicle}</td>
                  <td className="px-6 py-4 hover:bg-[var(--gray-100)] transition-all duration-200">
                    {getStatusBadge(driverStatuses[driver.id] || "Unknown")}
                  </td>
                  <td className="px-6 py-4 text-center hover:bg-[var(--gray-100)] transition-all duration-200">{driver.totalRides}</td>
                  <td className="px-6 py-4 hover:bg-[var(--gray-100)] transition-all duration-200">
